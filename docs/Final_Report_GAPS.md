...
|----|-----|---------|--------|--------|
| D-01 | DETR-R50 backbone trained on CLAY and evaluated zero-shot on the labelled desktop test set. Proposal Section 7.B requires both YOLOv8 and DETR for RQ3. Currently only YOLOv8 numbers exist. | Ch6, Ch7, Ch8 | new Colab notebook `09_detr_source.ipynb` + `10_detr_finetune.ipynb` | **IN PROGRESS** — Phase 4.2 sub-phase opened 26 May 2026; notebooks 09-10 to be drafted when author starts the sub-phase. |
